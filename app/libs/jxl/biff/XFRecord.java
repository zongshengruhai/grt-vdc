...
public class XFRecord extends WritableRecordData implements CellFormat
{
  ...
  public XFRecord(FontRecord fnt, DisplayFormat form)
  {
    ...
    leftBorderColour   = Colour.DEFAULT_BORDER;
    rightBorderColour  = Colour.DEFAULT_BORDER;
    topBorderColour    = Colour.DEFAULT_BORDER;
    bottomBorderColour = Colour.DEFAULT_BORDER;
  ...
  public byte[] getData()
  {
    ...
    if (borderMask != 0)
    {
    	...
    	data[12] = (byte)((lc & 0x7f) | ((rc & 0x01) << 7));
    	data[13] = (byte)((rc & 0x7f) >> 1);
    	data[14] = (byte)((tc & 0x7f) | ((bc & 0x01) << 7));
    	data[15] = (byte)((bc & 0x7f) >> 1);
    }

    // Set the background pattern
    IntegerHelper.getTwoBytes(pattern.getValue(), data, 16);
