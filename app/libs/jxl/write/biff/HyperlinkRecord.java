...
public class HyperlinkRecord extends WritableRecordData
{
  ...
  private byte[] getFileData(byte[] cd)
  {
    ...
    byte[] d = new byte[cd.length + 22 + (shortFilePath.length() + 1) * 2 +
                        34 + filePath.length() * 2];
    System.arraycopy(cd, 0, d, 0, cd.length);
    ...
    // Inexplicable byte sequence
    d[filePos]    = (byte) 0x03;
    d[filePos+1]  = (byte) 0x03;
    d[filePos+2]  = (byte) 0x0;
    d[filePos+3]  = (byte) 0x0;
    d[filePos+4]  = (byte) 0x0;
    d[filePos+5]  = (byte) 0x0;
    d[filePos+6]  = (byte) 0x0;
    d[filePos+7]  = (byte) 0x0;
    d[filePos+8]  = (byte) 0xc0;
    d[filePos+9]  = (byte) 0x0;
    d[filePos+10] = (byte) 0x0;
    d[filePos+11] = (byte) 0x0;
    d[filePos+12] = (byte) 0x0;
    d[filePos+13] = (byte) 0x0;
    d[filePos+14] = (byte) 0x0;
    d[filePos+15] = (byte) 0x46;
    ...
    int curPos=filePos+22+(shortFilePath.length() + 1)*2;
